...
export const page: LandingPage = {
  ...
  scopeTitle: "Flooring Installation Scope And Planning Range",
  scopeIntro: "Line items for a 300 square foot living room, luxury vinyl plank at a mid-range price point.",
  scopeLines: [
    { item: "Demo And Haul Away, Existing Flooring", qty: "300 SF", trade: "Flooring", low: 450, high: 900 },
    { item: "Subfloor Repair And Leveling", qty: "300 SF", trade: "Flooring", low: 300, high: 900 },
    ...
    { item: "Baseboard Removal And Reinstall", qty: "70 LF", trade: "Carpentry", low: 280, high: 700 },
    { item: "Transition Strips And Trim", qty: "3 doorways", trade: "Flooring", low: 120, high: 300 },
    { item: "Furniture Move And Setup", qty: "1 room", trade: "General", low: 100, high: 300 },
  ],
  ...
  howTo: {
    ...
    steps: [
      ...
      { name: "Add Demo, Underlayment And Trim", text: "Include removal of old flooring, underlayment, transition strips and baseboard reinstall as separate line items, not assumed inside the material price." },
