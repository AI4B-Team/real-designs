...
export const page: LandingPage = {
  ...
  steps: [
    ...
    { title: "Set Ceiling Height And Style", text: "Confirm ceiling height if known, then choose a furnishing style and budget band." },
    { title: "Get The 3D View And Walkthrough", text: "Review the furnished 3D render and an optional short walkthrough video of the same layout." },
  ],
  ...
  sections: [
    ...
    {
      h2: "Furnishing To Scale And The Walkthrough Output",
      body: [
    ...
    {
      h2: "What Surveyors And Architects Still Need To Do",
      body: [
  ...
  howTo: {
    ...
    steps: [
      ...
      { name: "Upload And Choose A Style", text: "Submit the plan along with a furnishing style and budget band." },
