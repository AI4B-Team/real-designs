  ...
  <div class="wrap sc-wrap">
    ...
    <div class="sc-grid" id="scGrid">
      ...
      ${wipeCard(
        1,
        "Interior Redesign",
        "Restyle A Room You Actually Own",
      ...
      ${wipeCard(
        3,
        "Landscape Design",
        "See The Yard Before You Break Ground",
      ...
      ${card(
        5,
        "Declutter",
        "Clear The Room, Keep The Architecture",
      ...
      ${card(
        4,
        "Virtual Staging",
        "Furnish A Vacant Listing By Lunch",
      ...
      ${card(
        6,
        "Reality Lock",
        "Lock What Stays, Change What Does Not",
      ...
      ${card(
        8,
        "Photo Enhancement",
        "Make Every Listing Photo Look Its Best",
      ...
      ${card(
        ...
        <div class="sc-shop">
          ...
          ${[
            ...
            .map(
              ([l, t], i) =>
                `<span class="sc-hot${i === 2 ? " sc-hot-main" : ""}" style="left:${l};top:${t};--d:${i * 0.16}s"></span>`,
            )
            .join("")}
      ...
      ${card(
        11,
        "Walkthrough Video",
        "Post It Before The Listing Goes Live",
      ...
      ${card(
        12,
        "MLS Disclosure",
        "The Disclosure Nobody Else Automates",
