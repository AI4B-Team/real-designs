...
export const SE_MOTIONS: SeMotion[] = [
  {
    id: "auto",
    label: "Auto",
    blurb: "Best Movement For This Scene",
    seconds: 8,
    prompt:
      "Move the camera smoothly and naturally from the first framing to the final framing at an even pace.",
  },
  {
    id: "walkthrough",
    label: "Walkthrough",
    blurb: "Move Forward Through The Space",
    seconds: 8,
    prompt:
      "A steady eye-level walkthrough moving forward through the space, ending on the final framing.",
  },
  {
    id: "push_in",
    label: "Push In",
    blurb: "Move Toward The Subject",
    seconds: 6,
  ...
  },
  {
    id: "pull_out",
    label: "Pull Out",
    blurb: "Reveal More Of The Space",
    seconds: 6,
    prompt:
      "A slow pull out that gradually reveals more of the space, settling on the final framing.",
  },
  {
    id: "pan",
    label: "Pan",
    blurb: "Move Across The Scene",
    seconds: 6,
  ...
  },
  {
    id: "orbit",
    label: "Orbit",
    blurb: "Curve Around The Subject",
    seconds: 8,
  ...
  },
  {
    id: "reveal",
    label: "Reveal",
    blurb: "End On The Selected Frame",
    seconds: 8,
  ...
  },
  {
    id: "custom",
    label: "Custom",
    blurb: "Describe Your Own Movement",
    seconds: 8,
...
export function seDone(
  row?: { status?: string | null; clip_path?: string | null } | null,
): boolean {
