...
const ROWS: Row[] = [
  ...
  { id: "bauhaus", name: "Bauhaus", cat: "Clean and Modern", t: "ie", pal: "retro", img: "midcentury",
    ...
    feat: ["primary colour blocking", "geometric form", "function first"], desc: "Geometric form, primary accents, function first." },
  ...
  { id: "maximalist", name: "Maximalist", cat: "Expressive and Collected", t: "i", pal: "deco", img: "luxury",
    ...
    feat: ["saturated colour", "pattern on pattern", "full walls of art"], desc: "Saturated colour and confident pattern." },
  ...
  { id: "retro", name: "Retro", cat: "Expressive and Collected", t: "i", pal: "retro", img: "midcentury",
    ...
    feat: ["period colour", "curved seating", "playful pattern"], desc: "Period colour, curves and playful pattern." },
  ...
  { id: "modern-country", name: "Modern Country", cat: "Farmhouse and Country", t: "ie", pal: "farmhouse", img: "farmhouse",
    ...
    feat: ["clean lines with country warmth", "muted colour", "simple hardware"], desc: "Country warmth with clean modern lines." },
  ...
  { id: "victorian", name: "Victorian", cat: "Exterior Architecture", t: "e", pal: "classic", img: "paintedBrick",
    ...
    feat: ["ornate trim", "steep roofs", "multi colour paint"], desc: "Ornate trim, steep roofs and layered paint.", rooms: ["Front Elevation"] },
