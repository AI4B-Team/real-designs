...
export const ROOM_OPTIONS: RoomOption[] = [
  ...
  { id: "side-exterior", label: "Side Exterior", icon: "house", space: "exterior", group: "Exterior & Outdoor" },
  { id: "driveway", label: "Driveway", icon: "route", space: "exterior", group: "Exterior & Outdoor" },
  { id: "balcony", label: "Balcony", icon: "fence", space: "exterior", group: "Exterior & Outdoor" },
  ...
  { id: "garden", label: "Garden", icon: "flower-2", space: "landscape", group: "Exterior & Outdoor" },
  { id: "landscaping", label: "Landscaping", icon: "sprout", space: "landscape", group: "Exterior & Outdoor" },
  { id: "outdoor-living", label: "Outdoor Living", icon: "armchair", space: "landscape", group: "Exterior & Outdoor" },
