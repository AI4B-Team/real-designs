          ...
          step: [
            {
              ...
              text: "Take a wide shot from a corner of the room so two walls and the floor are visible.",
            },
            {
              "@type": "HowToStep",
              position: 2,
              name: "Choose An Intensity",
              text: "Refresh keeps the layout and changes surfaces. Renovation allows cabinetry, tile and fixtures to move.",
            },
            {
              "@type": "HowToStep",
              position: 3,
              name: "Generate The Design",
              text: "Reality Lock holds the walls, windows and doors in place while finishes change.",
            },
            {
              "@type": "HowToStep",
              position: 4,
              name: "Compare The Directions",
              text: "Regenerate at another intensity or style and compare the versions side by side.",
            },
          ],
        }),
      },
