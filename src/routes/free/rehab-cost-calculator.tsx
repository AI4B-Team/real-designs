          ...
          step: [
            {
              ...
              position: 1,
              name: "List The Rooms",
              text: "Add every room you intend to touch, with its approximate square footage.",
            },
            {
              "@type": "HowToStep",
              position: 2,
              name: "Set A Finish Grade",
              text: "Choose rental grade, retail grade or high end for each room separately.",
            },
            {
              "@type": "HowToStep",
              position: 3,
              name: "Read The Range",
              text: "The calculator returns a low and high planning range built from published unit rates.",
            },
            {
              "@type": "HowToStep",
              position: 4,
              name: "Add Contingency",
              text: "Carry ten to twenty percent on top before you treat the number as a budget.",
            },
          ],
        }),
      },
