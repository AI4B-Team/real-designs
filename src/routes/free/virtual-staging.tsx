...
export const Route = createFileRoute("/free/virtual-staging")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "/free/virtual-staging" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [{ rel: "canonical", href: "/free/virtual-staging" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          step: [
            { "@type": "HowToStep", position: 1, name: "Shoot The Empty Room", text: "Photograph from a corner at chest height with the lights on and the blinds open." },
            { "@type": "HowToStep", position: 2, name: "Pick A Direction", text: "Choose a furnishing direction that matches the buyer the listing is aimed at." },
            { "@type": "HowToStep", position: 3, name: "Stage The Room", text: "Furniture is placed to the scale of the real room, with the architecture held in place." },
            { "@type": "HowToStep", position: 4, name: "Label The Image", text: "Add the virtual staging disclosure your MLS and state require before publishing." },
          ],
        }),
      },
    ],
