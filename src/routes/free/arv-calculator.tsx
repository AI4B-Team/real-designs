          ...
          step: [
            {
              "@type": "HowToStep",
              position: 1,
              name: "Pull Comparable Sales",
              text: "Find closed sales of similar size and condition within a short radius and a recent window.",
            },
            {
              "@type": "HowToStep",
              position: 2,
              name: "Set The After Repair Value",
              text: "Take the price per square foot the renovated comparables achieved and apply it to your subject.",
            },
            {
              "@type": "HowToStep",
              position: 3,
              name: "Enter The Rehab Budget",
              text: "Use the high end of your rehab planning range, not the optimistic figure.",
            },
            {
              "@type": "HowToStep",
              position: 4,
              name: "Apply The Rule",
              text: "Seventy percent of ARV minus rehab gives a maximum allowable offer to start from.",
            },
          ],
        }),
      },
